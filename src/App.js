  ...
  return (
    <>
      <Header>
        <Wrapper>
          <Logo />
          <Button as="a" href="/video/new">Novo Vídeo</Button>
        </Wrapper>
      </Header>
      <Banner>
        <TextContainer>
          ...
          <Description>
            ...
            histórias legais que decidimos fazer uma série de vídeos com esse bate
            papo tão incrível que tivemos com o Maujor® - O dinossauro das CSS!!!
          </Description>
        </TextContainer>
        <Thumbnail 
          src={maujor} 
      ...
      <Footer >
        <Logo />
        <p>
          Site feito na <Link href="https://alura.com.br"><LogoImersao /></Link>
        </p>
      </Footer>
    </>
  );
